...
{
    /// <summary>
    /// A class added after developing the entire hierarchy
    /// </summary>
    public class ContainerShip : Semitrailer
    {
        ...
        public ContainerShip(string name, double maxMass, string typeOfGoods, string storageConditions, double mass, double massOfGoods) : base(name, maxMass, typeOfGoods, storageConditions, mass, massOfGoods)
        {
        }
        ...
        {
            return obj is ContainerShip ship &&
                   base.Equals(obj) &&
                   Name == ship.Name &&
                   MaxMass == ship.MaxMass &&
                   TypeOfGoods == ship.TypeOfGoods &&
                   StorageConditions == ship.StorageConditions &&
                   Mass == ship.Mass &&
                   MassOfGoods == ship.MassOfGoods;
        }
        /// <summary>
